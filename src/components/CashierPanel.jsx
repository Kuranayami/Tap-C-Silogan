      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    items.map(order => (
                      ...
                      >
                        ...
                        {order.total !== undefined && (
                          <p className="text-sm font-bold text-[#f97316] mb-2">₱{Number(order.total).toLocaleString()}</p>
                        )}
        ...
        {orders.some(o => ['done', 'canceled'].includes(o.status)) && (
          <details className="mt-6 rounded-2xl border border-[#27272a] bg-[#18181b]">
            <summary className="px-4 py-3 text-sm text-[#a1a1aa] cursor-pointer hover:text-white transition-colors">
