...
export default function CashierProfile({ onBack }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FFFBDA]">
    ...
    <div className="min-h-screen bg-[#FFFBDA]">
      <div className="max-w-lg mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#4A3728]">Cashier Profile</h1>
        </div>
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-[#4A3728]/60 mb-1.5">Username</label>
            <input type="text" value={username} disabled
              className="w-full px-4 py-2.5 rounded-xl bg-[#FFFBDA] border border-[#FFEC9E] text-[#4A3728]/50 text-sm cursor-not-allowed opacity-60" />
            <p className="text-[#4A3728]/50 text-xs mt-1">Username cannot be changed</p>
          </div>
