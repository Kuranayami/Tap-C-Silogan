...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-start md:items-center pt-20 scroll-mt-20 bg-[#FFFBDA]">
      ...
      <div className="absolute bottom-1/4 -right-32 w-80 h-80 bg-[#D48040]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FFEC9E] border border-[#FFBB70] text-[#D48040] text-xs sm:text-sm font-medium mb-6">
              <Star className="w-4 h-4 fill-[#D48040] text-[#D48040]" />
              <span>{storeInfo.rating} ★ ({storeInfo.reviewCount} Reviews)</span>
              <span className="w-1 h-1 rounded-full bg-[#D48040]/40" />
              <span>Family-friendly</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-[1.1] tracking-tight mb-6 text-[#D48040]">
              Savor the{' '}
            ...
            <div className="flex flex-wrap items-center gap-4 justify-center lg:justify-start mb-10">
              <button
                onClick={openCart}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#D48040] hover:bg-[#FFBB70] text-[#FFFBDA] font-semibold transition-all shadow-lg shadow-[#D48040]/10 active:scale-95"
              >
                Order Now
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <a href="#menu" className="text-[#D48040]/40 hover:text-[#FFBB70] transition-colors">
