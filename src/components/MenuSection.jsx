...
function MenuItemCard({ item, index, onAdd, addingId }) {
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-2xl border-2 border-[#FFEC9E] bg-[#FFFBDA] overflow-hidden transition-all duration-300 hover:border-[#FFBB70] hover:shadow-xl hover:shadow-[#D48040]/5"
          ...
          {item.category === 'extra' ? (
            ...
            <>
              ...
              <button
                ...
                className="p-2 rounded-lg bg-[#D48040] hover:bg-[#FFBB70] text-[#FFFBDA] transition-all active:scale-90 disabled:opacity-50"
              >
                {addingId === item.id ? (
    ...
    <section id="menu" className="relative py-24 sm:py-32 scroll-mt-24 bg-[#FFFBDA]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <button
            onClick={openCart}
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#FFFBDA] border border-[#FFEC9E] text-[#D48040] hover:border-[#FFBB70] font-medium transition-all shadow-sm"
          >
